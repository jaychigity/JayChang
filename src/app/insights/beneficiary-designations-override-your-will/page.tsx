      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
          <AnimateOnScroll>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl font-bold text-[#333333] mb-4">Which Accounts Have Beneficiary Designations?</h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl font-bold text-[#333333] mb-4">Why Beneficiary Designations Override Everything</h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl font-bold text-[#333333] mb-4">Common Mistakes with Beneficiary Designations</h2>

              <h3 className="font-serif text-xl font-bold text-[#333333] mb-3 mt-6">Mistake 1: Naming an Estate as Beneficiary</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="font-serif text-xl font-bold text-[#333333] mb-3 mt-6">Mistake 2: Failing to Update After Major Life Events</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="font-serif text-xl font-bold text-[#333333] mb-3 mt-6">Mistake 3: Naming a Minor as Direct Beneficiary</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="font-serif text-xl font-bold text-[#333333] mb-3 mt-6">Mistake 4: Not Coordinating with Your Trust</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="font-serif text-xl font-bold text-[#333333] mb-3 mt-6">Mistake 5: Ignoring Per Stirpes vs. Per Capita Designations</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl font-bold text-[#333333] mb-4">Arizona Community Property Rules</h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl font-bold text-[#333333] mb-4">How to Get Your Beneficiary Designations Right</h2>

              <h3 className="font-serif text-xl font-bold text-[#333333] mb-3 mt-6">Step 1: Make a Complete List</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="font-serif text-xl font-bold text-[#333333] mb-3 mt-6">Step 2: Review Your Designations Against Your Estate Plan</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="font-serif text-xl font-bold text-[#333333] mb-3 mt-6">Step 3: Consider Whether to Name a Trust</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="font-serif text-xl font-bold text-[#333333] mb-3 mt-6">Step 4: Update All Designations</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="font-serif text-xl font-bold text-[#333333] mb-3 mt-6">Step 5: Document Your Wishes</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl font-bold text-[#333333] mb-4">The Annual Review</h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl font-bold text-[#333333] mb-4">What Your Family Needs to Know</h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl font-bold text-[#333333] mb-4">The Bottom Line</h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            <section className="bg-[#F7F4EE] rounded-lg p-8 mb-12 mt-16">
              <h3 className="font-serif text-xl font-bold text-[#333333] mb-4">Protect Your Estate Plan</h3>
