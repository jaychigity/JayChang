...
export const metadata: Metadata = {
 ...
 description: 'Meet Jay Chang, a fiduciary wealth advisor in Tempe, Arizona. I specialize in retirement income planning, investment strategy, tax planning, and wealth building for professionals, business owners, and families across all wealth stages.',
 alternates: {
