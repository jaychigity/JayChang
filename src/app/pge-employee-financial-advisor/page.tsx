                ...
                <div className="space-y-4 text-[#333333]">
                  <div>
                    ...
                    <p className="text-base leading-relaxed">
                      ...
                      highest 36-consecutive-month average. There is generally no lump sum option — your benefit pays as a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <AnimateOnScroll>
              <div className="bg-white border border-[#E8E6E1] rounded-[12px] p-[32px] h-full">
                ...
                <p className="text-[#333333] text-base leading-relaxed">
                  The RMSA balance at retirement is the same — it&apos;s accumulated by PG&amp;E regardless of when you
            ...
            <AnimateOnScroll>
              <div className="bg-white border border-[#E8E6E1] rounded-[12px] p-[32px] h-full">
                ...
                <p className="text-[#333333] text-base leading-relaxed">
                  For Cash Balance participants, the lump sum is simply your account balance — there&apos;s no interest
