...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/tools/telecom-pension-calculator`, lastModified: '2026-05-06', changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${baseUrl}/tools/utility-pension-calculator`, lastModified: '2026-05-06', changeFrequency: 'monthly' as const, priority: 0.7 },
    ...
    { url: `${baseUrl}/tools/cash-flow-planner`, lastModified: '2026-04-25', changeFrequency: 'monthly' as const, priority: 0.7 },
  ]
