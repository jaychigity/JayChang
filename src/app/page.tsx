...
export default function Home() {
 ...
 <section className="relative bg-[#333333] flex items-center overflow-hidden">
  ...
  <div className="relative z-10 w-full container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl pt-10 lg:pt-20 pb-16 lg:pb-24">
 ...
 <section className="bg-[#2a2a2a] py-20 lg:py-32 overflow-hidden">
  ...
  <div className="hidden lg:block relative">
   ...
   <AnimateOnScroll delay={300}>
    ...
    <p className="font-sans text-[15px] text-[#F7F4EE]/70 leading-relaxed">
     Regular check-ins, proactive tax planning, real-time monitoring. When something changes, like a new job, a big purchase, or a market swing, I&apos;m already thinking about what it means for you.
    </p>
    </div>
   </AnimateOnScroll>
   </div>
