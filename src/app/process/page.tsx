...
export const metadata: Metadata = {
 ...
 description: 'See how I walk you through every step, from a simple intro call to an ongoing partnership that grows with you.',
 alternates: {
 ...
 <script
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "description": "From a simple intro call to an ongoing partnership. Here is how Jay Chang walks you through every step.",
      "step": [
        {
          "@type": "HowToStep",
          "position": 1,
